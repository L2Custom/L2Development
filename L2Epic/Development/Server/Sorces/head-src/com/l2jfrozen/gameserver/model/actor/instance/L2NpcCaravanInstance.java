...
import com.l2jfrozen.gameserver.ai.L2NpcCaravanAI;
 ...
 * @since    819
 */
public class L2NpcCaravanInstance extends L2NpcInstance
{
	...
	public L2NpcCaravanInstance(final int objectId, final L2NpcTemplate template)
	{
		...
		setAI(new L2NpcCaravanAI(new L2NpcCaravanAIAccessor()));
	}
	
	/**
	 * AI can't be deattached, npc must move always with the same AI instance.
	 * @param newAI AI to set for this L2NpcCaravanInstance
	 */
	@Override
	...
	public void onSpawn()
	{
		((L2NpcCaravanAI) getAI()).setHomeX(getX());
		((L2NpcCaravanAI) getAI()).setHomeY(getY());
		((L2NpcCaravanAI) getAI()).setHomeZ(getZ());
	}
	 ...
	 */
	protected class L2NpcCaravanAIAccessor extends AIAccessor
	{
		/**
