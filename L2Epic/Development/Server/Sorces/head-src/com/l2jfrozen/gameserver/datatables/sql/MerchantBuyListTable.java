 ...
 * @author ReynalDev
 */
public class MerchantBuyListTable
{
	private static final Logger LOGGER = Logger.getLogger(MerchantBuyListTable.class);
	private static MerchantBuyListTable instance;
	...
	public static MerchantBuyListTable getInstance()
	{
		if (instance == null)
		{
			instance = new MerchantBuyListTable();
		}
		
		return instance;
	}
	
	private MerchantBuyListTable()
	{
